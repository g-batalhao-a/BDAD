...
INSERT INTO cadeira VALUES ('EIA','Estruturas de Informacao e Algoritmos','IS','ECO');
INSERT INTO cadeira VALUES ('EP','Eletronica de Potencia','AC','JLS');
INSERT INTO cadeira VALUES ('IE','Instalacoes Eletricas','AC','JLS');

CREATE TABLE prova(
nr varchar2(5) REFERENCES aluno(nr),
cod varchar(50) REFERENCES cadeira(cod),
data date,
